            ...
            */
            ...
            if (_ids.length > 0 && _ids.length <= 10) {
              ...
              for (var i = 0; i < _ids.length; i++) {
                ...
                '                  <span class="pull-right animated" id="bmp180_temp-'+_id+'">',
                '                      0',
                '                  </span>',
                ...
                '                      0',
                '                  </span>',
                '                  <span class="label label-success" style="margin-right: 10px;">OK</span> Pression',
                '              </li>',
                '              <li class="list-group-item" style="padding: 10px 0; border-top: 1px solid #e7eaec; border-left:0; border-right: 0; border-bottom: 0;">',
                ...
                '                      0',
                '                  </span>',
                '                  <span class="label label-success" style="margin-right: 10px;">OK</span> Iluminance',
                '              </li>',
                '              <li class="list-group-item" style="padding: 10px 0; border-top: 1px solid #e7eaec; border-left:0; border-right: 0; border-bottom: 0;">',
